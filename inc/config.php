...
$config = [
    ...
    // อินโทรตอนเข้าเว็บ: ตัวอักษรเจาะทะลุเห็นภาพห้อง Server แล้วซูมออกตอนเลื่อนลง
    'intro' => [
        'enabled' => true,
        'text'    => 'TEXSON',
        'image'   => 'assets/img/intro-bg.svg',   // เปลี่ยนเป็นรูปถ่ายจริงได้ (ถ้าไฟล์ไม่มีจะใช้พื้นหลังไล่สีแทน)
    ],
